...
<center>
<figure>
	<img src="/public/img/ros/coord.png" alt="" width="30%" height="30%"> 
...
2. 회전변환을 점 P는 $A$좌표축 기준으로 $P_A = (1,1)$이고, $P_B=(\sqrt2,0)$이다.

이 때 점 $P_A$는 <span style="color:#f92672">위 4번 정의</span>에 의해 다음과 같이 $P_B$로 변환한다.

$P_B = R_{-\theta} P_A = \begin{bmatrix} cos(-\theta) & -sin(-\theta) \cr sin(-\theta) & cos(-\theta) \end{bmatrix} P_A = \begin{bmatrix} \sqrt2 & \sqrt2 \cr -\sqrt2 & \sqrt2 \end{bmatrix} \begin{bmatrix} 1 \cr 1 \end{bmatrix} = \begin{bmatrix} \sqrt2 \cr 0 \end{bmatrix}$
